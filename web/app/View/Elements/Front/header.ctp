...
<div class="offset4 span2">
    <div class="mediasocial-menu row-fluid">
        <a class="media-social media-youtube span4" target="new" title="youtube"><span class="hidden">youtube</span></a>
        <a class="media-social media-facebook span4" target="new" href="http://www.facebook.com/animetrigger" title="facebook"><span class="hidden">facebook</span></a>
        <a class="media-social media-twitter span4" target="new" title="twitter"><span class="hidden">twitter</span></a>
    </div>
</div>
    ...
    <ul class="row-fluid">
        <li class="span3">
            <a href="<?php echo $this->Html->url("/"); ?>" class="row-fluid">
                <p class="span8 <?php echo ($title_for_layout == 'Home')?'active':''; ?>">Home</p>
